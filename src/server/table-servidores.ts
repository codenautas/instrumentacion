...
export function servidores(context: TableContext): TableDefinition {
    ...
    return {
        ...
        fields: [
            ...
            { name: "usuario_backups_externos"   , typeName: 'text', title:'responsable backups dbs en PC'},
            { name: "backup_oficial"     , typeName: 'text', title:'backup oficial eq servidores'},
        ...
        detailTables:[
            ...
            {table: 'servidores_versiones'    , fields:['servidor'], abr:'PI', label:'productos instalados'      },
